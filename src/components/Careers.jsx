        ...
        <div className="career-details">
          ...
          <div className="career-box">
            ...
            <ul>
              ...
              <li>
                HR Support: Collaborate with dairy operations to align HR efforts
                with goals.
              </li>
            </ul>
          </div>
          ...
          <div className="career-box">
            ...
            <ul>
              ...
              <li>
                <strong>Experience:</strong> 3–5 years of HR experience, ideally
                in agriculture or dairy sector.
              </li>
              <li>
                <strong>Skills:</strong> Labor laws knowledge, leadership, strong
